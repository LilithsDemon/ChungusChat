<?php
    ...
    $SQL = "UPDATE `Users` SET `Username`='No_User', `FirstName`='Removed', `LastName`='User', `Password`='0', `Role`='',`About`='',`ImgSrc`='https://proficon.stablenetwork.uk/api/initials/Removed User.svg',`Admin`=0,`Creator`=0,`MaxRooms`=0 WHERE `UserID` = ?;";
    $result = executeCommand($SQL, 's', [$_SESSION['currentProfile']]);
